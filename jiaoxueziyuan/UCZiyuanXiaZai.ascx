...
&nbsp;关键字：<asp:TextBox ID="TextBox1" runat="server" MaxLength="20"></asp:TextBox>
        ...
        PageSize="15">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="文件下载(播放)">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl='<%# Eval("资源文件") %>' 
                                                Target="_blank" Text="文件下载(播放)"></asp:HyperLink>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:CommandField CausesValidation="False" SelectText="资源详情" 
                                        ShowSelectButton="True" HeaderText="资源详情" />
                                    <asp:TemplateField HeaderText="删除" ShowHeader="False">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" 
                                                CommandArgument='<%# Eval("资源ID") %>' onclick="LinkButton1_Click" 
                                                Text="删除" OnClientClick="javascript:return confirm('你确定要删除该资源吗？');"></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="编辑">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="HyperLink1" runat="server" 
                                                NavigateUrl='<%# Eval("资源id", "~/teacher/ziyuanedit.aspx?jiaoxueziyuanid={0}") %>' 
                ...
                <asp:HiddenField ID="HFziyuanlx" runat="server" Value="kecheng" />
                <br />
