<%@ Page Language="C#" ValidateRequest="false" MasterPageFile="youkeMasterPage.master" EnableTheming="true"  AutoEventWireup="true" CodeFile="zice.aspx.cs" Inherits="youke_zice" Title="基于知识树的多课程网络教学平台_游客_在线自测" EnableViewState="true"  %>
...
{ 
 ...
 <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <TR>
        <TD style="WIDTH: 173px; HEIGHT: 21px">测试范围：<asp:Label id="Labelzhishidian" runat="server" Width="447px"></asp:Label></TD>
            </TR>
            <TR>
                    <TD style="WIDTH: 173px">题目数量：<asp:Label id="Labeltimushu" runat="server" Width="125px"></asp:Label></TD>
                 </TR>
                 <TR>
                    <TD>
                        <asp:PlaceHolder ID="PlaceHolderceshitimu" runat="server" OnLoad="PlaceHolderceshitimu_PreRender"
                           ></asp:PlaceHolder>
                     </TD></TR>
                 <tr>
                     <td>
            ...
            <td>自测总结</td>
                ...
                <tr>
                    <td>
                        题目数量：<asp:Label ID="Labeltmsl" runat="server" Text="Label"></asp:Label></td>
                </tr>
                <tr>
                    <td>
                        测试成绩：<asp:Label ID="Labelchj" runat="server" Text="Label"></asp:Label></td>
                </tr>
                <tr>
                    <td >
                ...
                <tr>
                    <td>
                    <asp:Label ID="lbl_fankui1" runat="server" Visible="false"  ForeColor="Red" Font-Bold="true"></asp:Label>
                    </td>
                </tr>
            </table>
