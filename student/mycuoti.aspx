<%@ Page Title="" Language="C#" MasterPageFile="~/student/StudentMasterPage.master" AutoEventWireup="true" CodeFile="mycuoti.aspx.cs" Inherits="student_mycuoti" %>
...
<ItemStyle Width="40px"></ItemStyle>
                      ...
                      <asp:BoundField DataField="shuoming" HeaderText="解析"  ItemStyle-Width="100px">
<ItemStyle Width="100px"></ItemStyle>
                      </asp:BoundField>
                      <asp:BoundField DataField="ceshitime" HeaderText="时间" />
                  </Columns>
              </asp:GridView>          
        </td>
        </tr>
